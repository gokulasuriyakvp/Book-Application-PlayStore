...
import 'package:flutter_four_hour_work_week_book/display_word_text.dart';
import 'package:flutter_four_hour_work_week_book/drawer_navigation.dart';
import 'package:share_plus/share_plus.dart';


class PageViewWordText extends StatefulWidget {
  const PageViewWordText({Key? key}) : super(key: key);

  @override
  State<PageViewWordText> createState() => _PageViewWordTextState();
}

class _PageViewWordTextState extends State<PageViewWordText> {
